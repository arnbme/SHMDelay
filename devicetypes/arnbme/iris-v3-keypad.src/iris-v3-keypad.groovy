 ...
 *
 * Dec 31, 2019 Modified UEI version for Iris V3 by Arn Burkhoff, change voltages, adjust for no pin on arm set to 0000
 ...
 */
metadata {
	definition (name: "Iris V3 Keypad", namespace: "arnbme", author: "Mitch Pond") {
...
private getBatteryResult(rawValue) {
	...
	if (volts > 6.4)
		...
		{
		def minVolts = 5.2 	// Iris V3
		def maxVolts = 6.0 	// Iris V3
